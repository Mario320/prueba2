...
public class ColaboradorBean {
    ...
    if(modelo.ingresarColaborador(colaborador)!=1){
        ...
        JsfUtil.setFlashMessage("exito","Colaborador modificado exitosamente");
   ...
   public String eliminarColaborador(){
       ...
       return "listacol?faces-redirect=true";
      ...
      public String llenar(){
       HttpServletRequest request= (HttpServletRequest) FacesContext.getCurrentInstance().getExternalContext().getRequest();
        ...
        colaborador= modelo.encontrarColaborador(idColaborador);
       return "colaborador";
   }
